...
public class QuestionDatabase extends SQLiteOpenHelper {
   ...
   public static final String TABLE_NAME = "question";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertQuestion(db,"2 + 2 = ?","2","4","8","10","B");
        insertQuestion(db,"1 + 1 = ?","2","4","8","10","A");
        insertQuestion(db,"4 + 4 = ?","2","4","8","10","C");
        insertQuestion(db,"6 + 4 = ?","2","4","8","10","D");
        insertQuestion(db,"4 x 2 = ?","2","4","8","10","C");
    ...
    public boolean insertQuestion (SQLiteDatabase db,String question, String optionA, String optionB, String optionC,String optionD, String answer) {
